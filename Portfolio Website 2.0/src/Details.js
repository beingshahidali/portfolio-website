...
export const projectDetails = [
  {
    title: "Namaste Food",
    image: projectImage1,
    description: `Features :•  Shimmer UI,
...
•  create/publish blogs, • read others content•  Shimmer UI for smooth loading •  handle unknown URLs with an error page • all powered by a JSON Server backend.`,
    techstack: "ReactJs, Tailwind CSS, React Router DOM",
